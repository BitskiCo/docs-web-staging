...
1. Sign into the [Developer Portal](https://developer.bitski.com), and click the
   ...
   ![168](/images/e172a85-image11.png)
...
1. Click on your app’s name. In the Overview section, you’ll find your app’s ID
   ...
   ![1113](/images/e81a9a8-image2.png)
...
1. Still on your app’s page in the Developer Portal, click Credentials in the
   left column.
   ![222](/images/90db8a9-image6.png)
1. Click New Credential in the upper right.
   ![1108](/images/a3192b9-image8.png)
1. A popup appears with your newly created credentials. At the bottom, click
   ...
   secret.
   ![460](/images/dd89ec1-image13.png)
...
<Card title="Create an NFT contract" icon="file-signature" href="/recipes/create-nft-contract">
  Open Recipe
</Card>
...
<Card title="Deploy an NFT contract" icon="rocket" href="/recipes/deploy-nft-contract">
  Open Recipe
</Card>
...
<Card title="Create a Token Template" icon="files" href="/recipes/create-token-template">
  Open Recipe
</Card>
...
![1348](/images/37d08a4-image7.png "image7.png")
...
<Card title="Create an NFT" icon="hexagon-vertical-nft" href="/recipes/create-nft">
  Open Recipe
</Card>
